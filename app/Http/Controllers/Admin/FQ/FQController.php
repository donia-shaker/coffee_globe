...
namespace App\Http\Controllers\Admin\FQ;

use App\Http\Controllers\Controller;
use App\Http\Requests\Admin\FQ\FQRequest;
use App\Models\FQ;
...
class FQController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($request->filled('search')) {
            ...
            $columns = Schema::getColumnListing((new FQ)->getTable());
        ...
        if (Schema::hasColumn((new FQ)->getTable(), $sort)) {
        ...
        return Inertia::render('Admin/FQs/Index', [
            'fqs' => $query->paginate($perPage), // استخدم $perPage هنا
    ...
    {
        return Inertia::render('Admin/FQs/Create', [
            'langs' => getLangs(),
        ]);
    }
    ...
    {
        return Inertia::render('Admin/FQs/Edit', [
            'fq' => FQ::find($id),
            'langs' => getLangs(),
        ]);
    }
