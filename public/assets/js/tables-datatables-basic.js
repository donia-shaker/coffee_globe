...
document.addEventListener("DOMContentLoaded", function (e) {
    !(function () {
        const e = document.getElementById("form-add-new-record");
        setTimeout(() => {
            ...
            flatpickr(e.querySelector('[name="basicDate"]'), {
                enableTime: !1,
                dateFormat: "m/d/Y",
                onChange: function () {
        ...
        if (
            (fv.on("core.form.valid", function () {
                var t = $(".add-new-record .dt-full-name").val(),
                    ...
                    s = $(".add-new-record .dt-email").val(),
                    n = $(".add-new-record .dt-date").val(),
